                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-7">
                        <div class="wsus__check_form">
                            ...
                            <a href="javascript:;" style="margin-left:auto;" class="common_btn" data-bs-toggle="modal" data-bs-target="#exampleModal">agregar nueva</a>
                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="wsus__checkout_single_address">
                                        ...
                                        <ul>
                                            ...
                                            <li><span>País :</span> {{$address->country}}</li>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="wsus__order_details" id="sticky_sidebar">
                            <p class="wsus__product">Métodos de envío</p>
                            ...
                            <div class="wsus__order_details_summery">
                                ...
                                <p>cupón: <span>-{{$settings->currency_icon}}{{getCartDiscount()}}</span></p>
                            ...
                            <a href="" id="submitCheckoutForm" class="common_btn">Hacer pedido</a>
                        </div>
                    </div>
                </div>
        </div>
                        ...
                        <div class="wsus__check_form p-3">
                            <form action="{{route('user.checkout.address.create')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input type="text" placeholder="Departamento *" name="state" value="{{old('state')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input type="text" placeholder="Ciudad/Barrio *" name="city" value="{{old('city')}}">
                                        </div>
                                    </div>

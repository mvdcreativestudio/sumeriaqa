...
<header>
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="wsus_logo_area align-middle">
                    <a class="wsus__header_logo align-middle" href="{{url('/')}}">
                        <img src="{{asset($logoSetting->logo)}}" alt="logo" class="img-fluid w-100 align-middle">
                    </a>
                </div>
            </div>
    ...
    <div class="wsus__mini_cart">
        <h4>Carrito <span class="wsus_close_mini_cart"><i class="far fa-times"></i></span></h4>
            ...
            @foreach (Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{$sidebarProduct->rowId}}">
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <small>Total variantes: {{$settings->currency_icon}}{{$sidebarProduct->options->variants_total}}</small>
                        <br>
        ...
        <div class="mini_cart_actions {{Cart::content()->count() === 0 ? 'd-none': ''}}">
            <h5>Total <span id="mini_cart_subtotal">{{$settings->currency_icon}}{{getCartTotal()}}</span></h5>
            <div class="wsus__minicart_btn_area">
                <a class="common_btn" href="{{route('cart-details')}}">Ver Carrito</a>
                <a class="common_btn" href="{{route('user.checkout')}}">Finalizar Compra</a>
            </div>
        </div>
    </div>

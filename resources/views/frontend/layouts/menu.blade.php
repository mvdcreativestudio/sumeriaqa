            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        <li><a  class="{{setActive(['home'])}}" href="{{url('/')}}">Inicio</a></li>

                        <li><a class="{{setActive(['vendor.index'])}}" href="{{route('vendor.index')}}">locales</a></li>
                        <li><a class="{{setActive(['flash-sale'])}}" href="{{route('flash-sale')}}">ofertas</a></li>
                        <li><a class="{{setActive(['contact'])}}" href="{{route('contact')}}">contacto</a></li>


                    </ul>
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        <li><a href="{{route('product-traking.index')}}">Rastrear pedido</a></li>
                        @if (auth()->check())
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
                role="tab" aria-controls="pills-profile" aria-selected="false">Menú principal</button>
        </li>
    </ul>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample2">
                    <ul>
                        ...
                        <li><a href="{{route('vendor.index')}}">locales</a></li>
                        ...
                        <li><a href="{{route('product-traking.index')}}">Rastrear pedidos</a></li>
                        <li><a href="{{route('flash-sale')}}">ofertas</a></li>
                    </ul>
                </div>
            </div>
        </div>
